    ...
    <div className="min-h-screen bg-gray-50 flex font-sans text-gray-900">
      ...
      <aside className="w-60 bg-emerald-950 shrink-0 flex flex-col p-4">
        ...
        <div className="mt-auto flex flex-col gap-1">
          <Link
            href="/donations"
            className="flex items-center justify-center gap-2 px-3 py-2.5 rounded-lg bg-emerald-600 text-white text-sm font-semibold mb-4 hover:bg-emerald-700 transition-colors"
          >
          ...
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row sm:items-start justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-gray-500 max-w-sm">
                Vitality Food Redistribution Platform. Delivering Care and Precision with
                every donation.
              </p>
            </div>
