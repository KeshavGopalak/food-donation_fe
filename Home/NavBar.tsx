...
export default function Navbar() {
  ...
  <nav className="w-full flex items-center p-5 border-b-2 border-gray-200 bg-[#FFFFFF]">
    ...
    <h1 className="text-3l font-bold text-darkgreen text-xl">Vitality logistics</h1>
    <p className=" text-darkgreen underline font-bold">dashboard</p>
    <p className="">Impact</p>
    <p className="">Community</p>
    </span>
    
    <span className=" flex items-center justify-around w-1/8 ml-auto">
       <p className=" text-darkgreen">Role Switcher</p>
