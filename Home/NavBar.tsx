...
export default function Navbar() {
  ...
  return (
    <nav className="w-full flex items-center justify-between px-4 md:px-8 py-4 border-b-2 border-gray-200 bg-white font-inter shadow-sm">
      <div className="flex items-center gap-3 md:gap-6">
        <h1 className="text-lg md:text-2xl font-bold text-darkgreen">
          <Link href="/">Vitality Logistics</Link>
        </h1>
        ...
        <div className="flex items-center gap-3 md:gap-6">
          <Button variant="secondary" className="hidden sm:block text-darkgreen text-sm md:text-base">
            <Link href="/login" className="flex items-center gap-3 md:gap-6">Login</Link>
          </Button>
          <Button variant="secondary" className="hidden sm:block text-darkgreen text-sm md:text-base">
            <Link href="/register" className="flex items-center gap-3 md:gap-6">Register</Link>
          </Button>
        </div>
