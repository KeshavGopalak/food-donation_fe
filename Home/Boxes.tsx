  ...
  return (
    <div className="w-full flex flex-col items-center justify-center gap-6 md:gap-8 font-inter py-12 md:py-20 px-4 sm:px-6 md:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full max-w-4xl">
        {/* Green Box */}
        <div className="bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-3xl md:rounded-4xl flex flex-col justify-center p-6 md:p-8 gap-6 md:gap-10 text-white shadow-md hover:shadow-lg transition-all duration-300">
        ...
        {/* Orange Box */}
        <div className="bg-gradient-to-br from-amber-500 to-amber-600 rounded-3xl md:rounded-4xl flex flex-col items-center justify-center p-6 md:p-8 gap-3 text-white shadow-md hover:shadow-lg transition-all duration-300">
      ...
      {/* Footprint Box */}
      <div className="bg-gradient-to-r from-blue-50 to-emerald-50 rounded-3xl md:rounded-4xl flex flex-col lg:flex-row items-center justify-between gap-6 md:gap-8 p-6 md:p-8 border border-emerald-200 w-full max-w-5xl shadow-sm hover:shadow-md transition-all duration-300">
